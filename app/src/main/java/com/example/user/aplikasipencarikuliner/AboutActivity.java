...
public class AboutActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intentku =  new Intent(AboutActivity.this, MainActivity.class);
            startActivity(intentku);
        } else if (id == R.id.nav_bookmark) {
            Toast.makeText(this, "Bookmark dipilih", Toast.LENGTH_SHORT).show();
            Intent intentku =  new Intent(AboutActivity.this, BookmarkActivity.class);
            startActivity(intentku);
        } else if (id == R.id.nav_about) {
            Toast.makeText(this, "About Dipilih", Toast.LENGTH_SHORT).show();
            Intent intentku =  new Intent(AboutActivity.this, AboutActivity.class);
            startActivity(intentku);
